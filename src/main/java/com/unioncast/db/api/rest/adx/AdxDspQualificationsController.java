 ...
 */
@Api(value = "ADX_DSP_资质")
@RestController
@RequestMapping("/rest/adxDspQualifications")
public class AdxDspQualificationsController extends GeneralController {

    private static final Logger LOG = LogManager.getLogger(AdxDspQualificationsController.class);

    @Autowired
    private AdxDspQualificationsService adxDspQualificationsService;
    ...
    public RestResponse page(@RequestBody PageCriteria pageCriteria)
        ...
        restResponse.setResult(adxDspQualificationsService.page(pageCriteria));
    ...
    public RestResponse find(@RequestBody(required = false) Long id) throws DaoException {
        ...
        restResponse.setStatus(RestResponse.OK);
        restResponse.setResult(adxDspQualificationsService.find(id));
        LOG.info("restResponse:{}", restResponse);
        return restResponse;
    ...
    public RestResponse batchAdd(@RequestBody AdxDspQualifications[] adxDspQualifications) throws DaoException {
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        Long[] ids = adxDspQualificationsService.batchAdd(adxDspQualifications);
        LOG.info("ids:{}", ids);
    ...
    public RestResponse batchDelete(@RequestBody Long[] ids) throws DaoException {
        RestResponse restResponse = new RestResponse();
        int i = adxDspQualificationsService.batchDelete(ids);
        restResponse.setStatus(RestResponse.OK);
...
//        RestResponse restResponse = new RestResponse();
//        restResponse.setStatus(RestResponse.OK);
//        AdxDspQualifications adxDspQualifications = adxDspQualificationsService.findById(id);
//        LOG.info("adxSspReportFormHour:{}", adxDspQualifications);
//        restResponse.setResult(adxDspQualificationsService.findById(id));
//        return restResponse;
//    }
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "adxDspQualifications", required = true, dataType = "AdxDspQualifications", paramType = "body")})
    @RequestMapping(value = "/add", method = RequestMethod.POST)
    public RestResponse add(@RequestBody AdxDspQualifications adxDspQualifications) throws DaoException, IllegalArgumentException, IllegalAccessException {
        LOG.info("adxDspQualifications:{}", adxDspQualifications);
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        Long id = adxDspQualificationsService.save(adxDspQualifications);
        LOG.info("id:{}", id);
    ...
    public RestResponse update(@RequestBody AdxDspQualifications adxDspQualifications) throws DaoException, IllegalArgumentException, IllegalAccessException {
        LOG.info("adxDspQualifications:{}", adxDspQualifications);
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        restResponse.setResult(adxDspQualificationsService.updateAndReturnNum(adxDspQualifications));
        LOG.info("restResponse:{}", restResponse);
        return restResponse;
    }
    ...
    public RestResponse delete(@RequestBody Long id) throws DaoException {
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        int i = adxDspQualificationsService.deleteById(id);
        LOG.info("the number of delete:{}", i);
        restResponse.setResult(i);
        return restResponse;
    }
