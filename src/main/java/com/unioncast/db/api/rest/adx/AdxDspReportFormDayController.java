 ...
 */
@Api(value = "ADX_DSP_报表_天")
@RestController
@RequestMapping("/rest/adxDspReportFormDay")
public class AdxDspReportFormDayController extends GeneralController {

    private static final Logger LOG = LogManager.getLogger(AdxDspReportFormDayController.class);

    @Autowired
    private AdxDspReportFormDayService adxDspReportFormDayService;
    ...
    public RestResponse page(@RequestBody PageCriteria pageCriteria)
        ...
        restResponse.setResult(adxDspReportFormDayService.page(pageCriteria));
    ...
    public RestResponse find(@RequestBody(required = false) Long id) throws DaoException {
        ...
        restResponse.setStatus(RestResponse.OK);
        restResponse.setResult(adxDspReportFormDayService.find(id));
        LOG.info("restResponse:{}", restResponse);
        return restResponse;
    ...
    public RestResponse batchAdd(@RequestBody AdxDspReportFormDay[] adxDspReportFormDay) throws DaoException {
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        Long[] ids = adxDspReportFormDayService.batchAdd(adxDspReportFormDay);
        LOG.info("ids:{}", ids);
    ...
    public RestResponse batchDelete(@RequestBody Long[] ids) throws DaoException {
        RestResponse restResponse = new RestResponse();
        int i = adxDspReportFormDayService.batchDelete(ids);
        restResponse.setStatus(RestResponse.OK);
...
//        RestResponse restResponse = new RestResponse();
//        restResponse.setStatus(RestResponse.OK);
//        AdxDspReportFormDay adxDspReportFormDay = adxDspReportFormDayService.findById(id);
//        LOG.info("adxSspReportFormHour:{}", adxDspReportFormDay);
//        restResponse.setResult(adxDspReportFormDayService.findById(id));
//        return restResponse;
//    }
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "adxDspReportFormDay", required = true, dataType = "AdxDspReportFormDay", paramType = "body")})
    @RequestMapping(value = "/add", method = RequestMethod.POST)
    public RestResponse add(@RequestBody AdxDspReportFormDay adxDspReportFormDay) throws DaoException, IllegalArgumentException, IllegalAccessException {
        LOG.info("adxDspReportFormDay:{}", adxDspReportFormDay);
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        Long id = adxDspReportFormDayService.save(adxDspReportFormDay);
        LOG.info("id:{}", id);
    ...
    public RestResponse update(@RequestBody AdxDspReportFormDay adxDspReportFormDay) throws DaoException, IllegalArgumentException, IllegalAccessException {
        LOG.info("adxDspReportFormDay:{}", adxDspReportFormDay);
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        restResponse.setResult(adxDspReportFormDayService.updateAndReturnNum(adxDspReportFormDay));
        LOG.info("restResponse:{}", restResponse);
        return restResponse;
    }
    ...
    public RestResponse delete(@RequestBody Long id) throws DaoException {
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        int i = adxDspReportFormDayService.deleteById(id);
        LOG.info("the number of delete:{}", i);
        restResponse.setResult(i);
        return restResponse;
    }
