 ...
 */
@Api(value = "ADX_DSP_操作记录表")
@RestController
@RequestMapping("/rest/adxDspOperationRecord")
public class AdxDspOperationRecordController extends GeneralController {

    private static final Logger LOG = LogManager.getLogger(AdxDspOperationRecordController.class);

    @Autowired
    private AdxDspOperationRecordService adxDspOperationRecordService;
    ...
    public RestResponse page(@RequestBody PageCriteria pageCriteria)
        ...
        restResponse.setResult(adxDspOperationRecordService.page(pageCriteria));
    ...
    public RestResponse find(@RequestBody(required = false) Long id) throws DaoException {
        ...
        restResponse.setStatus(RestResponse.OK);
        restResponse.setResult(adxDspOperationRecordService.find(id));
        LOG.info("restResponse:{}", restResponse);
        return restResponse;
    ...
    public RestResponse batchAdd(@RequestBody AdxDspOperationRecord[] adxDspOperationRecord) throws DaoException {
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        Long[] ids = adxDspOperationRecordService.batchAdd(adxDspOperationRecord);
        LOG.info("ids:{}", ids);
    ...
    public RestResponse batchDelete(@RequestBody Long[] ids) throws DaoException {
        RestResponse restResponse = new RestResponse();
        int i = adxDspOperationRecordService.batchDelete(ids);
        restResponse.setStatus(RestResponse.OK);
...
//        RestResponse restResponse = new RestResponse();
//        restResponse.setStatus(RestResponse.OK);
//        AdxDspOperationRecord adxDspOperationRecord = adxDspOperationRecordService.findById(id);
//        LOG.info("adxSspReportFormHour:{}", adxDspOperationRecord);
//        restResponse.setResult(adxDspOperationRecordService.findById(id));
//        return restResponse;
//    }
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "adxDspOperationRecord", required = true, dataType = "AdxDspOperationRecord", paramType = "body")})
    @RequestMapping(value = "/add", method = RequestMethod.POST)
    public RestResponse add(@RequestBody AdxDspOperationRecord adxDspOperationRecord) throws DaoException, IllegalArgumentException, IllegalAccessException {
        LOG.info("adxDspOperationRecord:{}", adxDspOperationRecord);
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        Long id = adxDspOperationRecordService.save(adxDspOperationRecord);
        LOG.info("id:{}", id);
    ...
    public RestResponse update(@RequestBody AdxDspOperationRecord adxDspOperationRecord) throws DaoException, IllegalArgumentException, IllegalAccessException {
        LOG.info("adxDspOperationRecord:{}", adxDspOperationRecord);
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        restResponse.setResult(adxDspOperationRecordService.updateAndReturnNum(adxDspOperationRecord));
        LOG.info("restResponse:{}", restResponse);
        return restResponse;
    }
    ...
    public RestResponse delete(@RequestBody Long id) throws DaoException {
        RestResponse restResponse = new RestResponse();
        restResponse.setStatus(RestResponse.OK);
        int i = adxDspOperationRecordService.deleteById(id);
        LOG.info("the number of delete:{}", i);
        restResponse.setResult(i);
        return restResponse;
    }
