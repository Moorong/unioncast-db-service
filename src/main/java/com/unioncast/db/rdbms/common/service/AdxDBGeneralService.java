...
public abstract class AdxDBGeneralService<T extends Serializable, ID extends Serializable>
		implements GeneralService<T, ID> {

	protected AdxGeneralDao<T, ID> generalDao;

	public AdxGeneralDao<T, ID> getGeneralDao() {
		return generalDao;
	}

	public void setGeneralDao(AdxGeneralDao<T, ID> generalDao) {
